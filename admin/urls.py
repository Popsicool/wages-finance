...
urlpatterns = [
    ...
    path('single_investment/<str:id>', views.AdminSingleInvestment.as_view(), name='admin_single_investment'),
    path('investment_investors/<str:id>', views.AdminSingleInvestmentInvestors.as_view(), name='admin_single_investment_investors'),
    path('savings/<int:id>/', views.SavingsType.as_view(), name='admin_savings_type'),
